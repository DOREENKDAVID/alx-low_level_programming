 ...
 *
 * Descripion: extract ELF header class in 32 and 64 bit
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
...
/**
 * print_type - this func Prints the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
...
/**
 * print_entry - this func Prints the entry point of an ELF header.
...
/**
 * main - the func Displays the information contained in the
