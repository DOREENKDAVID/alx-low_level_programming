...
3. [200~Write a function that prints the numbers, from 0 to 9, followed by a new line.

Prototype: void print_numbers(void);
You can only use _putchar twice in your code

4. [200~Write a function that prints the numbers, from 0 to 9, followed by a new line.
